...
static void	provision_test_environment(int setup_type, char *saved_cwd, t_single_linked_node **env_lst)
{
	...
	else if (setup_type == 5)
	{
		...
		while (curr)
		{
			...
			if (var && var->key && strcmp(var->key, "HOME") == 0)
			{
				free(var->value);
				var->value = strdup("");
				break ;
...
int	test_cd(char **envp)
{
	...
	char	*case3[] =
	{
		"cd", "non_existent_directory_123", NULL
	};
	char	*case4[] =
	{
		"cd", "Makefile", NULL
	...
	// cd - when OLDPWD is missing
	char	*case13[] =
	{
		"cd", "test_broken_link", NULL
	};
	// cd targeting a broken symlink
	char	*case14[] =
	{
		"cd", "../../../../../../../../../../../../../../../..", NULL
	};
	// Deep root overflow fallback check
	t_cd_test	tests[] =
	{
		{
