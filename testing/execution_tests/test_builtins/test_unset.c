...
typedef struct s_unset_test
{
	...
	char	*check_missing_key;
	// Key to verify was successfully removed
}	t_unset_test;
...
static int	verify_key_missing(t_single_linked_node *env_lst, const char *key)
{
	...
	while (env_lst)
	{
		...
		if (var && var->key && strcmp(var->key, key) == 0)
			return (0);
		// Found it! That's a failure if we expected it gone.
...
int	test_unset(char **envp)
{
	...
	char	*case2[] =
	{
		"unset", "NON_EXISTENT_VARIABLE_XYZ", NULL
	};
	char	*case3[] =
	{
		"unset", "USER", NULL
	...
	char	*case5[] =
	{
		"unset", "LONELY_VAR", NULL
	};
	char	*case6[] =
	{
		"unset", "USER", "PATH", "HOME", NULL
	};
	char	*case7[] =
	{
		"unset", "invalid-id", NULL
	};
	char	*case8[] =
	{
		"unset", "123variable", NULL
	};
	char	*case9[] =
	{
		"unset", "", NULL
	...
	char	*case10[] =
	{
		"unset", "USER", "invalid@id", "PATH", NULL
	};
	// mixed scenario
